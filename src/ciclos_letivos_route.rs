...
use crate::ciclos_letivos_model::{CicloLetivos, InsertableCicloLetivo, UpdatableCicloLetivo};
use crate::schema;
use crate::DbConn;

#[post("/ciclos_letivos", data = "<ciclos_letivos>")]
pub fn create_ciclos_letivos(
    conn: DbConn,
    ciclos_letivos: Json<InsertableCicloLetivo>,
...
pub fn read_ciclos_letivos_unique(
    id: i32,
    conn: DbConn,
) -> Result<Json<Vec<CicloLetivos>>, String> {
    schema::ciclos_letivos::table
        .find(id)
        .load(&conn.0)
        .map_err(|err| -> String {
...
pub fn update_ciclos_letivos(
    id: i32,
    conn: DbConn,
    ciclos_letivos: Json<UpdatableCicloLetivo>,
) -> Result<String, String> {
