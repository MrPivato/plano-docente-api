...
use crate::schema;
use crate::professors_model::{InsertableProfessor, UpdatableProfessor, Professors};
use crate::DbConn;

#[post("/professors", data = "<professor>")]
pub fn create_professor(conn: DbConn, professor: Json<InsertableProfessor>) -> Result<String, String> {
...
pub fn read_professor(id: i32, conn: DbConn) -> Result<Json<Vec<Professors>>, String> {
    schema::professors::table.find(id)
    .load(&conn.0)
    .map_err(|err| -> String {
...
pub fn update_professor(id: i32, conn: DbConn, professor: Json<UpdatableProfessor>) -> Result<String, String> {
